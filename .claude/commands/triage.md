---
description: Surface open Linear issues assigned to me and flag what needs attention today.
---

Triage my Linear workload.

1. Fetch open issues assigned to the current user (state ≠ Done/Cancelled) via the Linear MCP.
